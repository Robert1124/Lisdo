const copy = {
  zh: {
    ...
    "workflow.title": "Payday your way 的节奏，换成 Lisdo 的 draft-first 工作流",
    ...
    "examples.text.body": "把 email、课程要求或会议记录粘进 Lisdo，AI 只生成可审核草稿，不直接写入正式待办。",
    "examples.pendingTitle": "正在整理为草稿",
    "examples.pendingBody": "提取文字、匹配分类、等待用户 review",
    "surfaces.title": "不是截图，是用网页重建的 Lisdo 组件",
    "surfaces.subtitle": "页面里的产品画面直接模仿源码组件：draft card、pending queue、Mac sidebar，以及 Gmail capture 转 draft 的流程。",
    "mac.title": "Lisdo Mac",
    "mac.inbox": "Inbox",
    "mac.drafts": "Drafts",
    "mac.today": "Today",
    ...
    "gmail.subject": "[MATH-022-500s-SP26] Reminder: Math 22 Final Exam",
    "gmail.time": "Tue, May 5, 9:53 AM",
    "gmail.sender": "Prof. Cream",
    "gmail.to": "to me",
    "gmail.p1": "Hello all,",
    "gmail.p2": "As a reminder, our Math 22 final exam will take place tomorrow at 12pm (noon). The exam is three hours long.",
    "gmail.p3": "Your section will take the exam in Packard 101. Students with extended-time accommodations will move to the extra-time room after standard time concludes.",
    "gmail.p4": "Good luck, and see y'all tomorrow.",
    "gmail.draftBadge": "Gmail 转草稿",
    "gmail.category": "School · 建议分类",
    "gmail.draftTitle": "准备 Math 22 final exam",
    "gmail.draftSummary": "Final exam 是明天中午 12 点，在 Packard 101，考试时长三小时，并留意 extended-time room 安排。",
    "gmail.step1": "中午前到 Packard 101",
    "gmail.step2": "预留 12 PM-3 PM 考试时间",
    "gmail.step3": "如需要，确认 extended-time 安排",
    "story.title": "安静一点，但工作流要完整",
    "story.p1": "Ko-fi 的动效是轻盈、友好、容易理解。Lisdo 借用这种节奏，但视觉回到原生 Apple 产品：纯净表面、近黑文字、低饱和状态色和克制阴影。",
    "story.p2": "页面避免夸张 AI 营销语言，因为 Lisdo 的价值不是炫技，而是让 messy capture 变成可检查、可同步、可执行的任务。",
    "faq.title": "常见问题",
    "faq.subtitle": "按产品路线图解释，不承诺 MVP 1 不包含的能力。",
  ...
  en: {
    ...
    "mock.widgetMeta": "Live Activity shell",
    "workflow.title": "Ko-fi's clear rhythm, reworked for Lisdo's draft-first flow",
    ...
    "examples.text.body": "Paste email, course requirements, or meeting notes into Lisdo. AI creates a reviewable draft instead of writing directly into your todo list.",
    "examples.pendingTitle": "Organizing into draft",
    "examples.pendingBody": "Extracting text, matching category, waiting for review",
    "surfaces.title": "Not screenshots. Lisdo components rebuilt in the page",
    "surfaces.subtitle": "The product visuals mirror source components: draft cards, pending queue, Mac sidebar, and a Gmail capture-to-draft flow.",
    "mac.title": "Lisdo Mac",
    "mac.inbox": "Inbox",
    "mac.drafts": "Drafts",
    "mac.today": "Today",
    ...
    "gmail.p3": "Your section will take the exam in Packard 101. Students with extended-time accommodations will move to the extra-time room after standard time concludes.",
    "gmail.p4": "Good luck, and see y'all tomorrow.",
    "gmail.draftBadge": "Draft from Gmail",
    "gmail.category": "School · suggested",
    "gmail.draftTitle": "Prepare for Math 22 final exam",
    "gmail.draftSummary": "Final exam is tomorrow at 12 PM in Packard 101. Plan for a three-hour exam and note the extended-time room move.",
    "gmail.step1": "Be at Packard 101 before noon",
    "gmail.step2": "Block 12 PM-3 PM for the exam",
    "gmail.step3": "Confirm extended-time instructions if needed",
    "story.title": "Quiet by design, complete in workflow",
    "story.p1": "Ko-fi's motion is light, friendly, and easy to understand. Lisdo borrows that pacing while returning the visuals to a native Apple product: clean surfaces, near-black ink, low-saturation status colors, and restrained shadows.",
    ...
    "faq.title": "FAQ",
    "faq.subtitle": "Answers follow the roadmap and do not promise features outside MVP 1.",
