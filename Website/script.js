const copy = {
  zh: {
    ...
    "support.a3Link": "更新页面",
    "support.a3Suffix": "。",
    "support.linksTitle": "App Store 链接",
    "support.linksBody": "公开构建可用后，这里会添加 TestFlight 或 App Store 链接。在此之前，开发状态以 GitHub 仓库为准。",
    ...
    "updates.downloadBody": "Mac 公开构建会发布在 GitHub Releases。iOS 分发准备好后会使用 TestFlight。",
    "updates.macDownload": "Mac 下载",
    "updates.iosDownload": "iOS 下载",
  ...
  en: {
    ...
    "support.a3Suffix": ".",
    "support.linksTitle": "App Store Links",
    "support.linksBody": "TestFlight or App Store links will be added here when public builds are available. Until then, development status is tracked in the GitHub repository.",
    ...
    "updates.downloadBody": "Mac public builds are published through GitHub Releases. iOS distribution will use TestFlight when it is ready.",
    "updates.macDownload": "Mac download",
    "updates.iosDownload": "iOS download",
