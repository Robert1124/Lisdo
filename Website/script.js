const copy = {
  zh: {
    ...
    "format.sourceBadge": "原始输入",
    "format.sourceTime": "今天 9:42 AM",
    "format.sourceTitle": "Math 22 final exam reminder",
    "format.sourceP1": "final exam tomorrow at 12pm noon, three hours",
    "format.sourceP2": "Packard 101. extended-time students move to extra-time room after standard time.",
  ...
  en: {
    ...
    "format.sourceBadge": "Raw input",
    "format.sourceTime": "Today, 9:42 AM",
    "format.sourceTitle": "Math 22 final exam reminder",
    "format.sourceP1": "final exam tomorrow at 12pm noon, three hours",
    "format.sourceP2": "Packard 101. extended-time students move to extra-time room after standard time.",
