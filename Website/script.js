const copy = {
  zh: {
    ...
    "faq.a5": "Mac 端已经开源，现在可以自己 build 使用；但还未完成完整测试和 debug，所以暂时没有安装包。测试完成后会 release 安装包。iOS 版本可通过 TestFlight 加入测试。",
    "faq.q6": "隐私和更新说明在哪里？",
  ...
  en: {
    ...
    "faq.a5": "The Mac app is open source and can be used by building it locally now. There is no installer package yet because full testing and debugging are not finished. An installer will be released after testing. The iOS version is available for testing through TestFlight.",
